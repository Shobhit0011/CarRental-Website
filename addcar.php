...
.register button {
    font-size: 18px; /* Adjust the font size of the input fields and button */
    padding: 10px 20px; /* Increase the padding for better visibility and interaction */
}
...
<header>
<button id="back"><a href="admindash.php">HOME</a></button> 
</header>
 <div class="main">
